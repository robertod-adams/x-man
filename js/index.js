...
// OBJETIVO 1 - quando passar o mouse em cima do personagem na listagem, devemos selecioná-lo
// passo 1 pegar os personagens no JS pra poder verificar quando o usuário passar o mouse em cima de
...
personagem.classList.add('selecionado');
      ...
      imagemPersonagemGrande.src = `./src/imagens x man/card-${idPersonagem}.png`;

      //passo 3 alterar o nome do personagem grandei
